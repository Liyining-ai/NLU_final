...
class GPT2SentimentClassifier(torch.nn.Module):
  ...
  def __init__(self, config):
    ...
    self.gpt = GPT2Model.from_pretrained("/home/ubuntu/NLP/ckpts")
  ...
  def forward(self, input_ids, attention_mask):
    ...
    return self.sentiment_classifier(self.hidden_dropout(outputs['last_token']))
...
class SentimentDataset(Dataset):
  def __init__(self, dataset, args):
    ...
    self.p = args
    self.tokenizer = GPT2Tokenizer.from_pretrained("/home/ubuntu/NLP/ckpts")
...
if __name__ == "__main__":
  ...
  config = SimpleNamespace(
    ...
    train='/home/ubuntu/NLP/downstream-tasks/data/ids-sst-train.csv', 
    dev='/home/ubuntu/NLP/downstream-tasks/data/ids-sst-dev.csv',
    test='/home/ubuntu/NLP/downstream-tasks/data/ids-sst-test-student.csv',
    fine_tune_mode=args.fine_tune_mode,
  ...
  config = SimpleNamespace(
    ...
    batch_size=8,
    hidden_dropout_prob=args.hidden_dropout_prob,
    train='/home/ubuntu/NLP/downstream-tasks/data/ids-cfimdb-train.csv',
    dev='/home/ubuntu/NLP/downstream-tasks/data/ids-cfimdb-dev.csv',
    test='/home/ubuntu/NLP/downstream-tasks/data/ids-cfimdb-test-student.csv',
    fine_tune_mode=args.fine_tune_mode,
